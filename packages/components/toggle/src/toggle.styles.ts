...
export const ToggleContainerStyled = styled.label<ToggleContainerStyledProps>`
  display: flex;
  flex-direction: row;
  align-items: center;
  gap: 0.5rem;
  ...
  ${(props: ToggleContainerStyledProps) =>
    props.disabled && toggleDisabledStyles}
`;
