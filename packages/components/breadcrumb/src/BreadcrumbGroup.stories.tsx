...
BiggerBreadcrumb.play = async ({
  ...
  expect(breadcrumb.textContent).toContain('Home1');
  expect(breadcrumb.textContent).toContain('Product1');
  expect(breadcrumb.textContent).toContain('Category1');
  expect(breadcrumb.textContent).toContain('...');
  expect(breadcrumb.textContent).toContain('Home17');
  expect(breadcrumb.textContent).toContain('Product17');
  expect(breadcrumb.textContent).toContain('Category17');
  ...
  expect(breadcrumb.textContent).toContain('Product1');
  await userEvent.click(home);
  expect(home).toHaveTextContent('Home1');
};
...
BiggerTextBreadcrumb.play = async ({
  ...
  await userEvent.click(product);
  expect(breadcrumb.textContent).toContain('Lorem ipsum dolor sit amet');
  expect(breadcrumb.textContent).toContain(
    'Lorem ipsum dolor sit amet, consectetur adipiscing...',
  );
  await userEvent.click(home);
